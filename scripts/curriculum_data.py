...
EXAM_CURRICULUM: dict[str, dict] = {
    ...
    "TYT Fizik": {
        ...
        "curriculum_model": None, "available_for_graduate": True,
        "topics": [
            # Geniş üniteler 2026-09-23'te alt konulara bölündü; eski adlar
            # "(Karma)".
            ("Fizik Bilimine Giriş", 9),
            ("Kütle, Hacim ve Özkütle", 9), ("Dayanıklılık", 9),
            ("Adezyon, Kohezyon ve Kılcallık", 9), ("Madde ve Özellikleri (Karma)", 9),
            ("Hareket", 9), ("Newton'un Hareket Yasaları", 9),
            ("Kuvvet ve Sürtünme", 9), ("Hareket ve Kuvvet (Karma)", 9),
            ("İş ve Güç", 9), ("Mekanik Enerji ve Korunumu", 9),
            ("Enerji Kaynakları", 9), ("İş, Güç ve Enerji (Karma)", 9),
            ("Isı, Sıcaklık ve İç Enerji", 9), ("Isı Alışverişi ve Hal Değişimi", 9),
            ("Genleşme", 9), ("Isının Yayılma Yolları", 9),
            ("Isı ve Sıcaklık (Karma)", 9),
            ("Elektrostatik", 10),
            ("Elektrik Akımı ve Ohm Yasası", 10), ("Elektrik Devreleri", 10),
            ("Elektrik Enerjisi ve Güç", 10), ("Elektrik (Karma)", 10),
            ("Manyetizma", 10),
            ("Basınç", 10), ("Kaldırma Kuvveti", 10),
            ("Basınç ve Kaldırma Kuvveti (Karma)", 10),
            ("Yay Dalgaları", 10), ("Su Dalgaları", 10), ("Ses Dalgaları", 10),
            ("Deprem Dalgaları", 10), ("Dalgalar (Karma)", 10),
            ("Aydınlanma ve Gölge", 10), ("Düzlem Aynalar", 10),
            ("Küresel Aynalar", 10), ("Işığın Kırılması", 10), ("Mercekler", 10),
            ("Renkler", 10), ("Optik (Karma)", 10),
        ],
    },
    "TYT Kimya": {
        "min_grade": 9, "max_grade": 12, "exam_section": "TYT",
        "curriculum_model": None, "available_for_graduate": True,
        "topics": [
            # Geniş üniteler 2026-09-23'te alt konulara bölündü (kitap bölümleri
            # + karneler bu incelikte); eski ünite adları "(Karma)".
            ("Kimya Bilimi", 9),
            ("Atom Modelleri ve Atomun Yapısı", 9), ("Periyodik Sistem", 9),
            ("Atom ve Periyodik Sistem (Karma)", 9),
            ("Güçlü Etkileşimler (Kimyasal Bağlar)", 9), ("Zayıf Etkileşimler", 9),
            ("Fiziksel ve Kimyasal Değişimler", 9),
            ("Kimyasal Türler Arası Etkileşimler (Karma)", 9),
            ("Gazlar", 9), ("Sıvılar", 9), ("Katılar", 9), ("Hal Değişimleri", 9),
            ("Maddenin Halleri (Karma)", 9),
            ("Kimyanın Temel Kanunları", 10), ("Mol Kavramı", 10),
            ("Kimyasal Tepkimeler ve Hesaplamalar", 10),
            ("Kimyanın Temel Kanunları ve Kimyasal Hesaplamalar (Karma)", 10),
            ("Karışımların Sınıflandırılması", 10), ("Çözünme ve Derişim", 10),
            ("Ayırma ve Saflaştırma", 10), ("Karışımlar (Karma)", 10),
            ("Asitler, Bazlar ve Tuzlar", 10),
            ("Kimya Her Yerde", 10),
        ],
    },
    "TYT Biyoloji": {
        ...
        "topics": [
            # Geniş üniteler 2026-09-23'te alt konulara bölündü; eski adlar
            # "(Karma)". Enerji konuları (Maarif 10. sınıf "Enerji" teması)
            # eklendi — 10. sınıf GİS karnelerinde vardı, listede olmadığı için
            # "Canlıların Ortak Özellikleri"ne yapıştırılıyordu.
            ("Canlıların Ortak Özellikleri", 9),
            ("İnorganik Bileşikler", 9), ("Organik Bileşikler", 9), ("Enzimler", 9),
            ("Canlıların Temel Bileşenleri (Karma)", 9),
            ("Hücre Organelleri", 9), ("Hücre Zarı ve Madde Geçişleri", 9),
            ("Hücre (Karma)", 9),
            ("Bakteriler ve Arkeler", 9), ("Protista, Bitki ve Mantarlar", 9),
            ("Hayvanlar Âlemi", 9), ("Virüsler", 9),
            ("Canlıların Sınıflandırılması (Karma)", 9),
            ("Mitoz ve Eşeysiz Üreme", 10), ("Mayoz ve Eşeyli Üreme", 10),
            ("Hücre Bölünmeleri (Karma)", 10),
            ("Mendel Genetiği ve Çaprazlamalar", 10),
            ("Kan Grupları ve Çok Alellilik", 10),
            ("Eşeye Bağlı Kalıtım ve Soyağaçları", 10),
            ("Mutasyon, Modifikasyon ve Varyasyon", 10),
            ("Kalıtımın Genel İlkeleri (Karma)", 10),
            ("Fotosentez ve Kemosentez", 10),
            ("Hücresel Solunum ve Fermantasyon", 10), ("Sindirim", 10),
            ("Ekosistemin Yapısı", 10), ("Madde ve Enerji Akışı", 10),
            ("Madde Döngüleri", 10), ("Ekosistem Ekolojisi (Karma)", 10),
    ...
    "TYT Coğrafya": {
        ...
        "topics": [
            ...
            ("Harita Bilgisi", 9), ("Coğrafi Konum", 9),
            # İklim + Yerin Şekillenmesi 2026-09-23'te bölündü ("(Karma)").
            ("Atmosfer ve Hava Olayları", 9), ("İklim Tipleri ve Bitki Örtüsü", 9),
            ("Türkiye'nin İklimi ve Bitki Örtüsü", 9), ("İklim Bilgisi (Karma)", 9),
            ("İç Kuvvetler", 10), ("Dış Kuvvetler", 10),
            ("Yerin Şekillenmesi (Karma)", 10),
