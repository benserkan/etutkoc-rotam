...
| **Bağımsız çalışma bildir (tatil/koçsuz)** | ✅ | ✅ | kitap→bölüm→test beyanı + geri çekme; koç onayı/toplu girişi WEB'de; onay push'u Kitaplarım'a deep-link; koç Müfredat sekmesinde "deneme doğrulamıyor" rozeti (Faz 3) mobilde de |
