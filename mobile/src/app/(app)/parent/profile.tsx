      ...
      <ScrollView contentContainerClassName="px-5 py-6 gap-5">
        ...
        <View className="rounded-2xl border border-slate-200 bg-white p-5">
          ...
          <View className="mt-3 flex-row items-center gap-2">
            <View className="rounded-full bg-brand-50 px-2.5 py-1">
              <Text className="text-xs font-semibold text-brand-700">Veli</Text>
            </View>
        ...
        >
          ...
          <Text className="mt-0.5 text-xs text-cyan-800">
            Rota, veli panelini sesli anlatarak gezdirir
          </Text>
        </Pressable>

        <Pressable
          onPress={() => void Linking.openURL("https://rotam.etutkoc.com/parent/settings")}
          className="rounded-2xl border border-slate-200 bg-white px-5 py-4 active:bg-slate-50"
        >
          <Text className="text-[15px] font-medium text-slate-900">Bildirim Tercihleri</Text>
          <Text className="mt-0.5 text-xs text-slate-500">E-posta/WhatsApp tercihlerini yönet (web)</Text>
        </Pressable>
